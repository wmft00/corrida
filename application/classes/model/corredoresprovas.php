...
Class Model_Corredoresprovas extends ORM {

    protected $_table_name = "CORREDORES_PROVAS";
    ...
    public function __construct($id = NULL) {
        //GERA A TABELA
        Database::instance()->query(Database::INSERT, "CREATE TABLE IF NOT EXISTS CORREDORES_PROVAS (
